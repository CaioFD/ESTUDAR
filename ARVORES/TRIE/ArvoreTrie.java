//CLASSE NÓ DA ARVORE TRIE (LISTA FLEXIVEL):
//CUSTO DA PESQUISA THETA (M X D) ONDE M É O TAMANHO DA PALAVRA PROCURADA E D É A PROFUNDIDADE DA PALAVRA NA ARVORE

//CLASSE NÓ DA ARVORE TRIE (BALANCEADA):
//CUSTO DA PESQUISA THETA (M X LG(D))

//CLASSE NÓ DA ARVORE TRIE (HASH PERFEITA):
//CUSTO DA PESQUISA THETA (M X 1)
